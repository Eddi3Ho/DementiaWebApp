            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <div class="row justify-content-md-center pt-5 pb-5">
                        ...
                        <!-- Steps -->
                        <div class="col-xl-3">
                            <div class="card h-100 transparent" id='card1'>
                                <div class="card-body">

                                    <div class="pl-3 pr-3 pt-4 ">
                                        <div class="pl-4" style="font-size:16px; font-weight:700; color:#F5F5F5;">Join Our Dementia System in</div>
                                        <div class="pt-2 pl-4 pb-3" style="font-family: 'Roboto', sans-serif; font-size:38px; color:#F5F5F5; font-weight:900;">3 STEPS</div>

                                        <div class="pl-4">
                                            <div class="number pt-4 pl-4 pb-1" style="font-size:18px; color:#d7eeff; font-weight:900;">01</div>
                                        </div>
                                        <div class="pl-4 pb-3" style="font-size:14px; color:#F5F5F5;">Make sure all the details are correct before register.</div>

                                        <div class="pl-4">
                                            <div class="number pt-4 pl-4 pb-1" style="font-size:18px; color:#d7eeff; font-weight:900;">02</div>
                                        </div>
                                        ...
                                        <div class="pl-4">
                                            <div class="number pt-4 pl-4 pb-1" style="font-size:18px; color:#d7eeff; font-weight:900;">03</div>
                                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card h-100 transparent id='card2' ">
                                <div class=" card-body">
                                    <center>
                                        <div class="pt-5 px-5" style="font-size:23px; letter-spacing: 8px; color:#F5F5F5; font-weight:700;">ROLE REGISTRATION PAGE</div>
                                    </center>
                                    <!-- Input fields (Form) -->
                                        ...
                                        <div class="form-row pt-3 px-3">
                                            <div class="form-group col-md-12 px-2 pl-3">
                                                <div class="form-group">
                                                    <label class="pb-2" for="relation" style="color:#F5F5F5; font-family: 'Roboto', sans-serif;">How are you related to dementia?</label>
                                                    <div class="row ">
                                                        <div class="col-md-6">
                                                            <div class="form-check pb-2">
                                                                <input class="form-check-input" type="radio" name="relation" id="relation1" value="1" required>
                                                                <label class="form-check-label" for="relation1" style="color:#F5F5F5;">
                                                                    Myself
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="relation" id="relation2" value="2">
                                                                <label class="form-check-label" for="relation2" style="color:#F5F5F5;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check pb-2">
                                                                ...
                                                                <label class="form-check-label" for="relation3" style="color:#F5F5F5;">
                                                                    Family Member or Friends
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="relation" id="relation4" value="4">
                                                                <label class="form-check-label" for="relation4" style="color:#F5F5F5;">
                                    ...
                                    <center>
                                        <div class="pt-5 pb-4">
                                            <a style="text-align:center;color:#d7eeff;" href="<?= base_url("user/auth/login"); ?>">Already have an account? Login!</a>
                                        </div>
                                        <div class="pb-2">
                                            <a style="text-align:center;color:#d7eeff" href="<?= base_url("user/auth/forgotPassword"); ?>">Forget your password?</a>
                                        </div>
                                    </center>
