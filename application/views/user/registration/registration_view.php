                            ...
                            <div class="card h-100 " id='card1'>
                                <div class="card-body" style="background-color:#B9EDDD">
                                    ...
                                    <div class="pl-3 pr-3 pt-4">
                                        <div class="pl-4" style="font-size:16px; font-weight:700; color:#0B666A;">Join Interactive Joint Education Employability System (iJEES) in</div>
                                        ...
                                        <div class="pl-4 pb-3" style="font-size:14px; color:black;">Fill in your detail correctly in the registration form.</div>
