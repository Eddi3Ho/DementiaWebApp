            ...
            <div id="content">
                ...
                <div class="container-fluid pb-5" style="background-color:#FFFF">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2 px-4 pt-3">
                        <h1 class="h3 mb-0  pt-4 font-weight-bold" style="color:#000000">Profile Settings</h1>
                    </div>
                    <div class="pb-2 px-4" style="text-align: justify; font-weight:500;color:#000000">
